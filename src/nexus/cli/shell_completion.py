...
def show_completion_prompt(shell_info: ShellInfo) -> bool:
    ...
    print()
    print(colored("Tab-completion will be enabled for:", "white"))
    print(colored("  • Commands (add, run, kill, etc.)", "white"))
    print(colored("  • Flags (-r, -p, --priority, etc.)", "white"))
    print(colored("  • File paths in your commands", "white"))
    print()
